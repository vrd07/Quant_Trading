...
# test_exhaustion_filter_path_runs_in_backtest removed 2026-08-13 — the
# exhaustion divergence filter was a feature of the old confluence gate,
# deleted along with it in favour of StrategyAllowlist, which has no
# exhaustion path to validate. See project_exhaustion_divergence_filter
# memory for the feature's history (it was OFF by default and never
# backtest-validated even while the old gate existed).
